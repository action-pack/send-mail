...
[![Size](https://img.shields.io/github/size/action-pack/set-variable/dist/index.js?branch=release/v1.1&label=size&color=066da5)](https://github.com/action-pack/set-variable/)
