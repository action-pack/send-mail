...
[![Size](https://img.shields.io/github/size/action-pack/set-variable/dist/index.js?branch=release/v4&label=size&color=066da5)](https://github.com/action-pack/set-variable/)
...
```YAML
uses: action-pack/set-variable@v4
with:
  name: 'MY_VARIABLE'
